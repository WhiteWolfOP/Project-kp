...
<head>
  ...
  <title><?php echo ($site->namaweb)?> | Konfigurasi wallpaper</title>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
           <li><a href="<?php echo base_url().'admin/konfigurasi'?>"><i class="fa fa-cog"></i> Konfigurasi umum</a></li>
            ...
            <li class="active"><a href="<?php echo base_url().'admin/konfigurasi/wallpaper'?>"><i class="fa fa-image"></i> Konfigurasi wallpaper 1</a></li>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <?php
                ...
                //form open
                echo form_open_multipart(base_url('admin/konfigurasi/wallpaper'), ' class="form-horizontal"');
              ?>
              ...
              <div class="form-group form-group-xs">
                ...
                <div class="col-md-5">
                  <input type="file" name="wallpaper" class="form-control" placeholder="Wallpaper" value="<?php echo $konfigurasi->wallpaper?>" required>
                  Wallpaper lama : <br><img src="<?php echo base_url('assets/upload/image/'.$konfigurasi->wallpaper)?>" class="img img-responsive img-thumbnail" width="200">
                </div>
              </div>
