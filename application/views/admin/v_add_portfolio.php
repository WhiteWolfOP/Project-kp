...
<head>
  ...
  <title><?php echo ($site->namaweb)?> | Add Portfolio</title>
        ...
        <li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url().'admin/konfigurasi/wallpaper'?>"><i class="fa fa-image"></i> Konfigurasi wallpaper 1</a>
            </li>
