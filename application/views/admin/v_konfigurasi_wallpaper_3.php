...
<head>
  ...
  <title><?php echo ($site->namaweb)?> | Konfigurasi wallpaper 3</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="<?php echo base_url().'admin/konfigurasi/wallpaper3'?>"><i class="fa fa-image"></i> Konfigurasi wallpaper 3</a>
            </li>
          </ul>
        </li>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <?php
                ...
                //form open
                echo form_open_multipart(base_url('admin/konfigurasi/wallpaper3'), ' class="form-horizontal"');
              ?>
              ...
              <div class="form-group form-group-xs">
                <label class="col-md-2 control-label">Upload Wallpaper baru:</label>
                <div class="col-md-5">
                  <input type="file" name="wallpaper3" class="form-control" placeholder="Wallpaper" value="<?php echo $konfigurasi->wallpaper3?>" required>
                  Wallpaper lama : <br><img src="<?php echo base_url('assets/upload/image/'.$konfigurasi->wallpaper3)?>" class="img img-responsive img-thumbnail" width="200">
                </div>
              </div>
