...
<head>
  ...
  <title><?php echo ($site->namaweb)?> | Konfigurasi</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/konfigurasi'?>"><i class="fa fa-cog"></i> Konfigurasi umum</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
                  ...
                  <div class="form-group form-group-xs">
                    <label class="col-md-2 control-label">Visi perusahaan:</label>
                    <div class="col-md-10">
                      <textarea name="visi" class="form-control" placeholder="Visi"><?php echo $konfigurasi->visi?></textarea>
                    </div>
                  </div>

                  <div class="form-group form-group-xs">
                    <label class="col-md-2 control-label">Misi perusahaan:</label>
                    <div class="col-md-10">
                      <textarea name="misi" class="form-control" placeholder="Misi"><?php echo $konfigurasi->misi?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group form-group-xs">
                    ...
                    <div class="col-md-10">
                      <textarea name="about_us" class="form-control" placeholder="Tentang perusahaan"><?php echo $konfigurasi->about_us?></textarea>
                    </div>
                  </div>
