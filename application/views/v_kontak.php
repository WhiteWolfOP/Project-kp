...
<html class="no-js">
	...
	<title><?php echo ($site->namaweb)?> | Kontak</title>
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'assets/upload/image/kontak.jpg'?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Kontak <?php echo ($site->namaweb)?>.</h2>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						...
						<li><i class="icon-globe"></i><a href="#"><?php echo ($site->email)?></a></li>
					</ul>
				</div>
