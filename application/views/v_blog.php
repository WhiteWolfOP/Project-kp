...
<html class="no-js">
	...
	<title><?php echo ($site->namaweb)?> | Event</title>
			...
			<div class="header-inner">
				...
				<nav role="navigation">
					<ul>
						...
						<li class="active"><a href="<?php echo base_url().'artikel'?>">Event</a></li>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					...
		   					<p class="fh5co-lead">List Event-event Yang Ada Di Seluruh Indonesia</p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
