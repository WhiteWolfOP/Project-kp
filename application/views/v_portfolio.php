...
<html class="no-js">
	...
	<title><?php echo ($site->namaweb)?> | Portfolio</title>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					...
		   					<p class="fh5co-lead">Portfolio Event</p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					<h2>Portfolio Event</h2>
					<p>Kami telah mensukseskan banyak event di indonesia.</p>
				</div>
			</div>
		</div>
		<?php
