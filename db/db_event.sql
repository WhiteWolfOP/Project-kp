...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2021 at 08:33 AM
...
(5, 'Investasi', '2016-09-06 06:19:26'),
(6, 'Olahraga', '2021-01-15 07:10:42');
...
CREATE TABLE `tbl_konfigurasi` (
  ...
  `wallpaper2` varchar(255) NOT NULL,
  `wallpaper3` varchar(255) NOT NULL,
...
INSERT INTO `tbl_konfigurasi` (`id_konfigurasi`, `nama_pemilik`, `namaweb`, `no_telp`, `email`, `alamat`, `visi`, `misi`, `about_us`, `wallpaper`, `wallpaper2`, `wallpaper3`, `icon`) VALUES
(1, 'DAD', 'Indonesia - Event', '087000000000', 'DAD123@gmail.com', 'Perumahan Semanggi Blok T-9 Jl. Rengginang kriuk no.90', 'Sebagai media untuk acara event yang akan di tampilkan atau di selenggarakan dari berbagai kota di indonesia', 'Mempromosikan acara event agar masyarakat dapat mengetahui informasinya, dan berharap agar acara event berjalan dengan baik', 'Perusahaan penyedia jasa dan media event dari berbagai kota di indonesia', 'rock.jpg', 'lantern.jpg', 'band.jpg', 'indonesiagaruda.png');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_owner_event`
--

CREATE TABLE `tbl_owner_event` (
  `id_owner` int(11) NOT NULL,
  `nama_owner` varchar(255) NOT NULL,
  `no_telp_owner` varchar(20) NOT NULL,
  `email_owner` varchar(255) NOT NULL,
  `alamat_owner` varchar(255) NOT NULL,
...
--
-- Dumping data for table `tbl_owner_event`
--

INSERT INTO `tbl_owner_event` (`id_owner`, `nama_owner`, `no_telp_owner`, `email_owner`, `alamat_owner`, `proposal_event`, `keterangan_event`, `status`) VALUES
(13, 'Adrian Alfauzi', '091876578490', 'Adrian@gmail.com', 'Surabaya Jl.Karangrejo gang 8', 'TEST.docx', 'Perayaan tahun baru di surabaya', 'terima'),
(14, 'Dandi Septian G', '091678567890', 'Dandi@gmail.com', 'Surabaya Jl.plaza marina', 'TEST.pdf', 'Bagi-bagi bakso gratis di wilayah surabaya ', 'terima'),
(15, 'Muhammad Dhika Firmansyah', '087897689432', 'Dhika@gmail.com', 'Surabaya jl karangrejo', 'TEST1.docx', 'Bagi-bagu takjil di lingkup surabaya sekitar', 'terima'),
(16, 'awdasd', '081230839771', 'awdad@gmail.com', 'awdasdawd', 'TEST2.docx', 'awdad', 'tolak');
...
(4, 'Admin', NULL, 'L', 'admin', 'e10adc3949ba59abbe56e057f20f883e', NULL, 'admin@gmail.com', '087897658956', NULL, NULL, NULL, NULL, 1, '1', '2021-01-22 01:17:47', 'a32b576de32e3e42535883172fc0b781.png');
...
(946, '2020-12-26 09:49:28', '::1', 'Chrome'),
(947, '2020-12-26 17:14:23', '::1', 'Chrome'),
(948, '2020-12-27 18:37:25', '::1', 'Chrome'),
(949, '2020-12-30 06:33:58', '::1', 'Chrome'),
(950, '2021-01-13 08:52:15', '::1', 'Chrome'),
(951, '2021-01-14 08:20:59', '::1', 'Chrome'),
(952, '2021-01-14 17:00:54', '::1', 'Chrome'),
(953, '2021-01-16 17:53:26', '::1', 'Chrome'),
(954, '2021-01-20 04:51:50', '::1', 'Chrome'),
(955, '2021-01-22 01:07:48', '::1', 'Chrome'),
(956, '2021-01-25 10:33:32', '::1', 'Chrome'),
(957, '2021-02-01 16:49:30', '::1', 'Chrome'),
(958, '2021-02-25 07:23:04', '::1', 'Chrome'),
(959, '2021-03-14 23:32:40', '::1', 'Chrome'),
(960, '2021-03-25 07:04:18', '::1', 'Chrome'),
(961, '2021-04-23 19:57:48', '::1', 'Chrome'),
(962, '2021-06-23 02:16:57', '::1', 'Chrome'),
(963, '2021-07-08 08:56:59', '::1', 'Chrome');
...
(1, 'Polygon Bikefest', '<p>Polygon Bikefest adalah sebuah Event yang di selenggarakan di bidang olahraga bersepeda, selain itu ada juga acara music dan kuliner untuk para masyarakat yang ingin datang untuk memeriahkan acara</p>\r\n\r\n<p>Acara Polygon Bikefest ini juga memiliki hadiah untuk para pendatang, yaitu dengan menghias sepeda dengan se unik mungkin, dan hadiahnya adalah 1 buah unit sepeda polygon</p>\r\n', '2017-07-20 03:53:59', 'Admin', 'e898f9dad58dfdaf8ee3bc9ce84ebaa7.png'),
(8, 'East Java Investival', '', '2021-01-15 00:52:47', 'Admin', 'ccd6ec9ed02824a6b622859c3f54483d.jpeg'),
(9, 'Gebyar startup virtual 2020', '', '2021-01-15 00:53:28', 'Admin', '295aa1f63c41bb7c4c103efde963e12c.jpg');
...
(55, '2020-12-28 08:42:12', '::1', 30),
(56, '2020-12-28 08:42:12', '::1', 0),
(57, '2020-12-30 08:18:56', '::1', 30),
(58, '2020-12-30 08:18:57', '::1', 0),
(59, '2020-12-30 08:23:40', '::1', 29),
(60, '2020-12-30 09:40:58', '::1', 28),
(61, '2020-12-30 10:00:26', '::1', 31),
(62, '2020-12-30 10:00:30', '::1', 25),
(63, '2020-12-30 10:00:54', '::1', 27),
(64, '2020-12-30 16:16:31', '::1', 26),
(65, '2021-01-13 08:52:55', '::1', 30),
(66, '2021-01-13 08:52:55', '::1', 0),
(67, '2021-01-13 08:53:11', '::1', 31),
(68, '2021-01-13 08:53:26', '::1', 26),
(69, '2021-01-14 10:13:11', '::1', 30),
(70, '2021-01-14 10:13:11', '::1', 0),
(71, '2021-01-15 00:41:01', '::1', 30),
(72, '2021-01-15 00:41:02', '::1', 0),
(73, '2021-01-15 07:10:14', '::1', 29),
(74, '2021-01-22 01:21:56', '::1', 29),
(75, '2021-01-22 01:21:56', '::1', 0),
(76, '2021-01-22 06:10:36', '::1', 30),
(77, '2021-01-22 06:16:33', '::1', 31),
(78, '2021-01-25 10:59:09', '::1', 29),
(79, '2021-01-25 10:59:10', '::1', 0),
(80, '2021-02-01 16:55:10', '::1', 30),
(81, '2021-02-01 16:55:11', '::1', 0),
(82, '2021-02-01 16:55:30', '::1', 31),
(83, '2021-02-01 16:55:34', '::1', 29),
(84, '2021-02-25 08:14:39', '::1', 30),
(85, '2021-02-25 08:14:40', '::1', 0),
(86, '2021-04-23 20:13:29', '::1', 31),
(87, '2021-04-23 20:13:29', '::1', 0),
(88, '2021-06-23 08:47:38', '::1', 32),
(89, '2021-06-23 08:47:39', '::1', 0);
...
(29, 'Polygon Bikefest', '<p><strong>AYO MARI KITA RAYAKAN MOMEN<br />\r\nINI BERSAMA SEBAGAI KELUARGA<br />\r\nPOLYGON DI EVENT BIKE FESTIVAL!</strong></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>Festival yang menggabungkan semua hal tentang sepeda, music, dan kuliner dalam satu hari!<br />\r\nAyo rayakan bersama kami dan jadilah bagian dari #PolygonFamily !</p>\r\n\r\n<p><strong>SABTU, 26 OKTOBER 2019</strong></p>\r\n\r\n<p><strong>Start Pukul 14:30 WIB</strong></p>\r\n\r\n<p><strong>POLYGON BIKES FACTORY<br />\r\nJl HR Moch. Mangundiprojo KM 3.5 Lingkar Timur<br />\r\nWadungasih &ndash; Buduran, Sidoarjo 61252</strong></p>\r\n', '2017-08-07 02:36:39', 6, 'Olahraga', 9, '4869eb66cbbffd6e4d9fa62e70821f16.png', 4, 'Admin', 0, 'polygon-bikefest.html', 1),
(30, 'Gebyar startup virtual 2020', '<p>Aris Mukiyono, Kepala DPMPTSP Provinsi Jawa Timur saat ditemui di ruang kerjanya menyampaikan, &ldquo;Gebyar Start Up Virtual 2020 merupakan satu satunya event virtual yang ada di Jawa Timur, yang menyatukan semua start up / anak muda di dalam bidang aplikasi, animasi yang ada di provinsi Jawa Timur&rdquo;.</p>\r\n\r\n<p>Bukan hanya itu, Gebyar Start Up Virtual 2020 akan menampilkan berbagai peluang bisnis untuk para Start Up baru dan akan mempertemukan pelaku usaha / start up dengan para investor baik PMA maupun PMDN, sehingga event ini membuka peluang terjalinnya kerjasama diantara keduanya.</p>\r\n\r\n<p>Rencananya acara akan dibuka oleh Wakil Gubernur Jawa Timur, Emil Elestianto Dardak dan dihadiri Konsulat Jendral dan Kedutaan dari 3 (tiga) Negara, yaitu Australia, Jepang dan Inggris.</p>\r\n\r\n<p>Beberapa nama besar tokoh-tokoh start up dan pakar ekonomi Jawa Timur akan mengisi acara tersebut sebagai pembicara. Sebut saja nama-nama seperti Bayu Skak, Agus Setyawan, Husna, Andie Boediman, Vicky&nbsp; Arief, Brillyanes Sanawiri, dan masih banyak lagi nama-nama tokoh start up yang tidak asing di kalangan kaum millenial Jawa Timur.</p>\r\n\r\n<p>Gebyar Start Up Virtual 2020 akan semakin menarik dengan hadirnya perform dari artis penyanyi Surabaya yang lagi tranding saat ini hingga manca negara, yaitu Sara Fajira.</p>\r\n\r\n<p>Info terbaru yang didapat dari panitia, antusiasme peserta yang sudah terdaftar sungguh luar biasa, dari kapasitas joint virtual 500 peserta yang disediakan panitia, hingga tadi pagi peserta sudah overload sekitar -/+ 200 peserta.</p>\r\n\r\n<p>Untuk memfasilitasi overload nya peserta yang akan mendaftar dan mendapatkan sertifikat, DPMPTSP membuka link pendaftaran yang bisa diakses melalui official website&nbsp;<a href=\"http://dpmptsp.jatimprov.go.id/\" target=\"_blank\">dpmptsp.jatimprov.go.id</a>&nbsp;dan akan menyiarkan secara Live Streaming di Chanel Youtube dan Instagram DPMPTSP Provinsi Jawa Timur. (ds)</p>\r\n', '2017-08-07 02:46:11', 5, 'Investasi', 19, '8139b46c5f3d13999fcfdca3d8906b61.jpg', 4, 'Admin', 0, 'gebyar-startup-virtual-2020.html', 1),
(31, 'East Java Investival', '<p>More than 18 Projects &amp; Products Ready to Offer : A. PT. Jatim Ghru (JGU) East Java with Shire Oak in the energy sector B. PT. Jatim Ghru (JGU) East Java and PT. Ronggolawe Sukses Mandiri (RSM) Tuban with Secro Asia Pacific in the Health sector C. PT. Barata Indonesia (PERSERO) with SUNG - IL ENCARE Co. Ltd in the field of Energy - Container - Type Small Scale LNG Plant Joint Production &amp; Marketing</p>\r\n\r\n<p>The realization of the East Java DDI was supported by transportation, warehouse and telecommunications sectors which contributed Rp. 18.72 trillion, while FDI realization was mainly supported by the chemical and pharmaceutical industry sector with the value of Rp4.26 trillion. Pasuruan Regency is a favorite of DDI location with a realization value of Rp2.6 trillion, meanwhile Surabya city be the FDI favorite with a realization value of IDR 11.5 trillion. Highest investment contribution came from Singapore with a realization of IDR4.03 trillion.</p>\r\n\r\n<p>USA, China, and Japan are East Java&rsquo;s main trading partners, both in exports and imports. Swiss has recently climbed up the ladder in East Java&rsquo;s list of export destinations, due to high export of jewellery. The Performance of East Java International trade is illustrated in the following infographic<br />\r\n(Source : LKPM, 2020)</p>\r\n', '2017-08-07 02:51:02', 5, 'Investasi', 15, 'e286e22182ddadf5a7dc0eaba389229f.jpeg', 4, 'Admin', 0, 'east-java-investival.html', 3),
(32, 'Judul', '<p>isi event</p>\r\n', '2021-06-23 08:40:20', 6, 'Olahraga', 1, '28c39dd7645eae3a9449ae9daa99821c.PNG', 4, 'Admin', 0, 'judul.html', 0);
...
--
-- Indexes for table `tbl_owner_event`
--
ALTER TABLE `tbl_owner_event`
  ADD PRIMARY KEY (`id_owner`),
  ADD UNIQUE KEY `no_telp_owner` (`no_telp_owner`,`email_owner`);
...
--
-- AUTO_INCREMENT for table `tbl_owner_event`
--
ALTER TABLE `tbl_owner_event`
  MODIFY `id_owner` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `tbl_post_views`
  MODIFY `views_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
